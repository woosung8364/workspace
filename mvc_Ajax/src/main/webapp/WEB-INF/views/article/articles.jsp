          ...
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-8 z-2">
              <div class="position-relative">
                ...
                <form action="/ajax/article/articles-action" method="post" role="form" class="needs-validation mb-5 mb-lg-7" novalidate>
                  <div class="row">
                    <div class="mb-3 text-end">
                      <label class="form-label">2023-05-05</label>
                      <textarea class="form-control" name="content" placeholder="누구든지 게시글을 입력할 수 있습니다...." required></textarea>
                    </div>
