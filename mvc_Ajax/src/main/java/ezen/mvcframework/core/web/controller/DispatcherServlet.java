...
import ezen.mvcframework.core.web.adapter.BasicControllerHandlerAdapter;
import ezen.mvcframework.core.web.adapter.WebControllerHandlerAdapter;
import ezen.mvcframework.core.web.adapter.HttpControllerHandlerAdapter;
 ...
 * 프론트 컨트롤러 구현
 */
@WebServlet(name = "/dispatcherServlet", urlPatterns = { "/ajax/*" })
