	...
	<nav class="navbar navbar-expand-lg navbar-light py-3">
		<div class="container position-relative">
			...
			<div
				...
				<div class="nav-item me-3 dropdown">
					<a href="/article/articles.jsp" class="btn btn-primary py-1">게시글</a>
				</div>
				...
				<div class="nav-item me-3 <c:if test="${empty loginMember }">dropdown</c:if>">
					<c:choose>
						...
						<c:otherwise>
							<span class="badge rounded-pill text-bg-warning me-3">${loginMember.id}(${loginMember.name})님 로그인중...</span>
