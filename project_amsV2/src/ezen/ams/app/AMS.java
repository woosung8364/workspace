...
//		가상 데이터 임시 등록
		repository.addAccount(new Account("배종현", 1234, 50000000));
		repository.addAccount(new Account("김기정", 1234, 10000000));
		repository.addAccount(new Account("홍길동", 1234, 30000000));
		repository.addAccount(new Account("배종현", 1234, 30000000));
		repository.addAccount(new MinusAccount("배종현", 1234, 0, 100000000));
	...
	private static void deposit() throws NotBalanceException { 
	 ...
	 * @throws NotBalanceException 
	 */
	private static void withdraw() throws NotBalanceException { 
		System.out.print("계좌번호: ");
		String accountNum = scanner.nextLine();
		Account a = repository.searchAccount(accountNum);
		if (a != null) {
