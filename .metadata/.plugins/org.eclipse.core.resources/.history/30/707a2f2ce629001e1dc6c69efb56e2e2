	...
	<nav class="navbar navbar-expand-lg navbar-light py-3">
		<div class="container position-relative">
			...
			<div
				...
				<div class="nav-item me-3 dropdown">
					<a href="${path}/member" class="btn btn-primary py-1">회원목록</a>
				</div>
				
				<div class="nav-item me-3 dropdown">
					<a href="${path}/article" class="btn btn-primary py-1">게시글</a>
				</div>
				...
				<div class="nav-item me-3 <c:if test="${empty loginMember }">dropdown</c:if>">
					...
					<div class="dropdown-menu dropdown-menu-end dropdown-menu-xs p-4">
						...
						<form class="needs-validation" novalidate
							action="${path}/member/signin" method="post">
							<div>
							...
							<p class="pt-4 mb-0 text-body-secondary text-end">
								<a href="${path}/member/signup" class="ms-2 pb-0 link-underline">회원가입</a>
							</p>
						</form>
						<!-- Sign In Form End-->
					</div>
